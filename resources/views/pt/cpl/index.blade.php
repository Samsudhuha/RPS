...
@section('title','Capaian Pembelajaran Semester')
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="float-right">
                    <a class="btn btn-success" href="/cpl/create/{{$id}}">Tambah Data Capaian Pembelajaran Semester</a>
                </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <table id="tableRps" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Capaian Pembelajaran Semester</th>
                            <th>Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                                        ...
                                        <div class="modal-content">
                                            <center>
                                                <div class="modal-header">
                                                    <h4 class="modal-title">Menghapus Data Capaian Pembelajaran Semester</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <p>Apakah anda yakin untuk menghapus data Capaian Pembelajaran Semester
                                                    <pre>Nomor {{ $cpl["no"] }}?</pre>
                                                    </p>
                                                </div>
