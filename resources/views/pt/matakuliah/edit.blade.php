    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-default">
                ...
                <form action="/matakuliah/edit/{{$matakuliah->id}}" method="post">
                    {{ csrf_field() }}
                    <div class=" card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="program_studi" class="form-control-lg select2" style="width: 100%;" value="{{ old('program_studi') }}">
                                        ...
                                        <option value="{{ $program_studi->id }}" @if($program_studi->id==$matakuliah->program_studi_id) selected @endif>{{ $program_studi->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6 fakultas">
                                <div class="form-group">
                                    ...
                                    <select name="fakultas" class="form-control-lg select2" style="width: 100%;">
                                        ...
                                        <option value="{{ $fakultas['id'] }}" @if($fakultas['id']==$matakuliah->fakultas_id) selected @endif>{{ $fakultas['name'] }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 rmk">
                                <div class="form-group">
                                    ...
                                    <select name="rmk" class="form-control-lg select2" style="width: 100%;">
                                        @foreach($rmks as $rmk)
                                        <option value="{{ $rmk['id']}}" @if($rmk['id']==$matakuliah->rmk_id) selected @endif>{{ $rmk['name'] }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mata-kuliah">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="matakuliah" class="form-control" value="{{$matakuliah->name}}" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 bobot">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="sks" class="form-control" value="{{$matakuliah->bobot}}" />
                                </div>
                            </div>
