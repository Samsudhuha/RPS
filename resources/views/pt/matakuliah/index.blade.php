        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="float-right">
                    <a class="btn btn-success" href="/matakuliah/create">Tambah Data Mata Kuliah</a>
                </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                                        ...
                                        <div class="modal-content">
                                            <center>
                                                ...
                                                <div class="modal-body">
                                                    <p>Apakah anda yakin untuk menghapus data mata kuliah
                                                    <pre>{{ $data["name"] }}?</pre>
                                                    </p>
                                                </div>
                                                <div class="modal-footer justify-content-between">
                                                    <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
                                                    <form action="/matakuliah/delete/{{$data['id']}}" method="post">
                                                        {{ csrf_field() }}
