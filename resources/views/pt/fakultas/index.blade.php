        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">List - Fakultas</li>
                </ol>
            </div>
        </div>
    </section>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="float-right">
                    <a class="btn btn-success" href="/fakultas/create">Tambah Data Fakultas</a>
                </div>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                                        ...
                                        <div class="modal-content">
                                            <center>
                                                <div class="modal-header">
                                                    <h4 class="modal-title">Menghapus Data Fakultas</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <p>Apakah anda yakin untuk menghapus data fakultas
                                                    <pre>{{ $data["name"] }}?</pre>
                                                    </p>
                                                </div>
                                                <div class="modal-footer justify-content-between">
                                                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                                    <form action="/fakultas/delete/{{$data['id']}}" method="post">
                                                        {{ csrf_field() }}
